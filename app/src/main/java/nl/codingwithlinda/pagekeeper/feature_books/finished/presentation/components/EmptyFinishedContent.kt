package nl.codingwithlinda.pagekeeper.feature_books.finished.presentation.components
...
fun EmptyFinishedContent(
    ...
    Column(
        ...
        Box(
            ...
            Icon(
                painter = painterResource(R.drawable.finished_big_icon),
...
@Composable
private fun EmptyFinishedContentPreview() {
    PageKeeperTheme {
